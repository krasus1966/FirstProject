...
public class EditSupplier extends JFrame {
    ...
    public EditSupplier(Supplier supplier) {
        ...
        public void add() {
            ...
            name_input.setText(supplier.getName());
            this.add(name_input);
            //联系方式
            ...
            contact_input.setText(supplier.getContact());
            ...
            tel_input.setText(supplier.getTel());
            this.add(tel_input);
            // 邮箱
            ...
            email_input.setText(supplier.getEmail());
            ...
            address_input.setText(supplier.getAddress());
            ...
            code_input.setText(supplier.getCode());
            this.add(code_input);
            // 备注
            ...
            note_input.setText(supplier.getName());
            this.add(note_input);
            // 提交按钮
